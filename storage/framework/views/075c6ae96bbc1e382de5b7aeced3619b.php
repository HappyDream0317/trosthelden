...
>
    <p>
        <?php if( auth()->user()->name ): ?>
            <?php echo e(__('Impersonating as')); ?> <?php echo e(auth()->user()->name); ?>

        <?php endif; ?>
    </p>

    <a href="<?php echo e(route('nova.impersonate.leave')); ?>" style="text-decoration:underline;color: black;font-weight: bold">
        <?php echo e(__('Reverse impersonate!')); ?>
...
<?php /**PATH /home/470763.cloudwaysapps.com/tudjznbtye/public_html/releases/a77e6f4d01eef97a18ce7ecea393eb6cf2d8a9c3/nova-components/nova-impersonate/resources/views/reverse.blade.php ENDPATH**/ ?>