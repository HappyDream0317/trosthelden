...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    onMatchAll: function onMatchAll() {
      this.loadingAll = true;
      this.userId = null;
      this.fetch();
    },
    onMatchUser: function onMatchUser() {
      this.errorMsg = '';
    ...
    fetch: function fetch() {
      ...
      Nova.request({
        ...
        if (data.status && data.status === "job dispatched" || data.status === "Job is already running.") {
          _this.refreshCacheStatus();
        } else {
          _this.loadingOne = false;
          _this.matchingHtml = data.html;
        }
      })["catch"](function (err) {
        console.error(err);
      });
    },
    downloadCache: function downloadCache() {
      var protocol = location.protocol;
      var slashes = protocol.concat("//");
      var host = slashes.concat(window.location.hostname);
      window.open("".concat(host, "/nova-vendor/matching/current"));
    },
    refreshCacheStatus: function refreshCacheStatus() {
      ...
      Nova.request({
        ...
        if (data.status && data.status === "processing") {
          _this2.loadingAll = "Matches werden momentan noch berechnet... Diese Seite wird automatisch aktualisiert.";
          setTimeout(_this2.refreshCacheStatus, 5000);
        } else {
          window.alert("Cache updated! Ready for HTML download.");
          _this2.loadingAll = false;
        }
      })["catch"](function (err) {
        console.error(err);
      });
...
var _hoisted_1 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", null, "Parameter", -1 /* HOISTED */);
var _hoisted_2 = {
...
var _hoisted_4 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", null, "Match All", -1 /* HOISTED */);
var _hoisted_5 = {
  "class": "inline-flex justify-center"
};
...
var _hoisted_14 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", null, "Match Specific User", -1 /* HOISTED */);
var _hoisted_15 = {
  "class": "inline-flex justify-center"
};
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_heading, {
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)("Matching")];
    }),
    _: 1 /* STABLE */
    ...
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["inline-flex justify-center rounded-lg text-sm font-semibold py-3 px-4 me-4", {
      'bg-primary-900': _ctx.debug,
      'bg-primary-300': !_ctx.debug
    }]),
    onClick: _cache[0] || (_cache[0] = function ($event) {
      return _ctx.debug = !_ctx.debug;
    })
  }, " debug ", 2 /* CLASS */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["inline-flex justify-center rounded-lg text-sm font-semibold py-3 px-4", {
      'bg-primary-900': _ctx.write,
      'bg-primary-300': !_ctx.write
    }]),
    onClick: _cache[1] || (_cache[1] = function ($event) {
      return _ctx.write = !_ctx.write;
    })
  }, " write ", 2 /* CLASS */)]), _hoisted_3, _hoisted_4, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_5, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "inline-flex justify-center rounded-lg text-sm font-semibold py-3 px-4 bg-primary-900 text-white hover:bg-primary-700 me-4",
    onClick: _cache[2] || (_cache[2] = function () {
      return $options.downloadCache && $options.downloadCache.apply($options, arguments);
    })
  }, "Download the cache"), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    ...
    disabled: _ctx.loadingAll,
    onClick: _cache[3] || (_cache[3] = function () {
      return $options.onMatchAll && $options.onMatchAll.apply($options, arguments);
    })
  }, "Rebuild cache for all matches", 8 /* PROPS */, _hoisted_6)]), _hoisted_7, _ctx.loadingAll ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("svg", _hoisted_8, [].concat(_hoisted_10))) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), _hoisted_11, typeof _ctx.loadingAll === 'string' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("b", _hoisted_12, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.loadingAll), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), _hoisted_13, _hoisted_14, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_15, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
    "onUpdate:modelValue": _cache[4] || (_cache[4] = function ($event) {
      return _ctx.userId = $event;
    }),
    "class": "appearance-none form-control form-input shadow me-4 py-3 px-4",
    style: {
      "margin-right": "30px"
    },
    type: "number"
  }, null, 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, _ctx.userId]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    "class": "inline-flex justify-center rounded-lg text-sm font-semibold py-3 px-4 bg-primary-900 text-white hover:bg-primary-700",
    disabled: _ctx.loadingOne,
    onClick: _cache[5] || (_cache[5] = function () {
      return $options.onMatchUser && $options.onMatchUser.apply($options, arguments);
    })
  }, "Match User", 8 /* PROPS */, _hoisted_16)]), _ctx.loadingOne ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("svg", _hoisted_17, [].concat(_hoisted_19))) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), typeof _ctx.loadingOne === 'string' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 3
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.loadingOne), 1 /* TEXT */)], 64 /* STABLE_FRAGMENT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), _ctx.errorMsg ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_20, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.errorMsg), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), _hoisted_21, _ctx.matchingHtml ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 5,
    "class": "inline-flex justify-center rounded-lg text-sm font-semibold py-3 px-4 bg-primary-900 text-white hover:bg-primary-700",
    style: {
      "margin-right": "30px"
    ...
    onClick: _cache[6] || (_cache[6] = function ($event) {
      return _ctx.matchingHtml = '';
    })
  }, "clear ")) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), _ctx.matchingHtml ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_22)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), _ctx.matchingHtml ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 7,
    innerHTML: _ctx.matchingHtml
...
Nova.booting(function () {
  Nova.inertia('Matching', _components_Tool__WEBPACK_IMPORTED_MODULE_0__["default"]);
});
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunktrosthelden_matching"] = self["webpackChunktrosthelden_matching"] || [];
